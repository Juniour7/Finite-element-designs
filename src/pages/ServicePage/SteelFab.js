            ...
            <section>
                ...
                >
                    <div className="mx-10 py-10">
                        <h1 className="text-3xl md:text-5xl font-bold text-white">Steel Fabrication Excellence</h1>
                        <h4 className="text-md font-semibold text-about-300 mt-7">Find out more about the variety of services we offer.</h4>
                    </div>
                </div>
                <body className="w-5/6 mx-auto leading-relaxed">
                    ...
                    <div className="text-md my-3">
                        <h2 className="font-bold text-xl text-about-600 ">Experienced Fabrication Team</h2>
                        <p>
                    ...
                    <div className="text-md my-3">
                        <h2 className="font-bold text-xl text-about-600 ">Customized Solutions</h2>
                        <p>
                    ...
                    <div className="text-md my-3">
                        <h2 className="font-bold text-xl text-about-600">Quality Assurance</h2>
                        <p>
                    ...
                    <div className="text-md my-3">
                        <h2 className="font-bold text-xl text-about-600">Compliance and Safety</h2>
                        <p>
                    ...
                    <div className="text-md my-3">
                        <h2 className="font-bold text-xl text-about-600">Timely Delivery</h2>
                        <p>
