            ...
            <section>
                ...
                >
                    <div className="mx-10 py-10">
                        <h1 className="text-3xl md:text-5xl font-bold text-white/100">Large Format Printing</h1>
                ...
                <body className="w-5/6 mx-auto">
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500 ">Precision and Detail</h1>
                        <p>
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500">Versatility and Flexibility</h1>
                        <p>
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500">Customized Solutions</h1>
                        <p>
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500">Fast Turnaround Times</h1>
                        <p>
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500">Quality Assurance</h1>
                        <p>
                    ...
                    <div className="my-4 text-md">
                        <h1 className="text-xl font-semibold text-about-500">Proffesional Expertise</h1>
                        <p>
