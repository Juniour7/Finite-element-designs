...
const Contact = () => {
    ...
    return (
        <>
            <NavBar />
            <section className="bg-fixed bg-center bg-cover bg-no-repeat w-full h-72"
            ...
            >
                <div className="ml-5 py-20">
                    <h1 className="text-4xl text-blue-500 font-bold py-auto">Contact Us</h1>
                    <hr className="w-32 mt-2 py-10"/>
                </div>  
            </section>
            <body className="mx-auto w-[90%] mt-7 lg:flex lg:justify-evenly">
                <div className="leading-loose">
                    ...
                    <form onSubmit={onSubmit} className="w-[90%] mb-5">
                        ...
                        <input type="submit" value="Send Inquiry" className="px-4 py-2 border-1 bg-blue-200 text-back/150 font-bold hover:bg-gray-500 hover:text-gray-950 cursor-pointer focus:outline-none"/>
                    </form>
                </div>
                <div>
                    <div className="w-90%">
                        ...
                        <div className="h-64 md:h-96 md:w-[600px]">
                            <iframe 
